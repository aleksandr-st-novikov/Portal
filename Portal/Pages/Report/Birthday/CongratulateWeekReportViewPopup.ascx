<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CongratulateWeekReportViewPopup.ascx.cs" Inherits="Portal.Pages.Report.Birthday.CongratulateWeekReportViewPopup" %>
