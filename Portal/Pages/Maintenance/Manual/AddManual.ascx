<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddManual.ascx.cs" Inherits="Portal.Pages.Maintenance.Manual.AddManual" %>
...
<dx:ASPxCallbackPanel ID="ASPxCallbackPanelAddManual" runat="server" ClientInstanceName="ASPxClientCallbackPanelAddManual" Width="100%" OnCallback="ASPxCallbackPanelAddManual_Callback">
    <ClientSideEvents EndCallback="function(s, e) {
	ASPxClientPopupControlAddManual.Show();
}" />
    <PanelCollection>
        <dx:PanelContent runat="server">
            <dx:ASPxPopupControl ID="ASPxPopupControlAddManual" runat="server" HeaderText="Создание инструкции" Modal="True" Width="1200px" ClientInstanceName="ASPxClientPopupControlAddManual" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Height="800px">
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                                ...
                                <dx:PanelContent runat="server">
                                    <div class="input-margin-bottom">
                                        <dx:ASPxTextBox ID="ASPxTextBoxName" runat="server" Caption="Название" Width="100%" ClientInstanceName="ASPxClientTextBoxName">
                                            <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="SaveManual">
                                    ...
                                    <div class="input-margin-bottom">
                                        <dx:ASPxHtmlEditor ID="ASPxHtmlEditorMainText" runat="server" Height="650px" Width="100%" ClientInstanceName="ASPxClientHtmlEditorMainText">
                                            ...
                                            <SettingsValidation ValidationGroup="SaveManual">
                                                <RequiredField ErrorText="Обязательное поле" IsRequired="True" />
                                            </SettingsValidation>
                                            <SettingsDialogs>
                                                <InsertImageDialog>
                                                    <SettingsImageUpload>
                                                        <FileSystemSettings UploadFolder="~/Content/Manuals/" />
                                                    </SettingsImageUpload>
                        ...
                        <dx:ASPxPanel ID="ASPxPanel2" runat="server" Width="100%" RightToLeft="True">
                            ...
                            <PanelCollection>
                                <dx:PanelContent runat="server">
                                    <dx:ASPxButton ID="ASPxButtonCancelManual" runat="server" Text="Отмена" AutoPostBack="False" ClientInstanceName="ASPxClientButtonCancelManual">
                                        <ClientSideEvents Click="function(s, e) {
	ASPxClientPopupControlAddManual.Hide();
}" />
                                    </dx:ASPxButton>
...
if(ASPxClientEdit.AreEditorsValid())
{
	ASPxClientCallbackSaveManual.PerformCallback(nodeKey);
            ...
            <dx:ASPxHiddenField ID="ASPxHiddenFieldEdit" runat="server" ClientInstanceName="ASPxClientHiddenFieldEdit">
            </dx:ASPxHiddenField>
...
<dx:ASPxCallback ID="ASPxCallbackSaveManual" runat="server" ClientInstanceName="ASPxClientCallbackSaveManual" OnCallback="ASPxCallbackSaveManual_Callback">
