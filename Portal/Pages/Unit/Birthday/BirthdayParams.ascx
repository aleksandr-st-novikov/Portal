...
<%@ Register Src="~/Pages/Unit/Birthday/CongratulateReportViewPopup.ascx" TagPrefix="uc1" TagName="CongratulateReportViewPopup" %>
<%@ Register Src="~/Pages/Unit/Birthday/CongratulateWeekReportViewPopup.ascx" TagPrefix="uc1" TagName="CongratulateWeekReportViewPopup" %>
