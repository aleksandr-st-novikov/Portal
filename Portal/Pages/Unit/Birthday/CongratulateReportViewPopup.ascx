<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CongratulateReportViewPopup.ascx.cs" Inherits="Portal.Pages.Unit.Birthday.CongratulateReportViewPopup" %>
