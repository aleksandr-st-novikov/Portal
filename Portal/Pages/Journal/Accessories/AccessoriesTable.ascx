...
<dx:ASPxCallbackPanel ID="ASPxCallbackPanelShowPopup" runat="server" ClientInstanceName="ASPxClientCallbackPanelShowPopup" OnCallback="ASPxCallbackPanelShowPopup_Callback">
    ...
    <PanelCollection>
        <dx:PanelContent runat="server">
            <dx:ASPxPopupControl ID="ASPxPopupControlAccessoriesTable" runat="server" AllowDragging="True" ClientInstanceName="ASPxClientPopupControlAccessoriesTable" CloseOnEscape="True" HeaderText="Заявка" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalOffset="50" Width="1200px" Height="800px">
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceAccessoriesTable" KeyFieldName="Id" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Кол-во" FieldName="Quantity" ShowInCustomizationForm="True" VisibleIndex="4">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="QuantityAgreed" ShowInCustomizationForm="True" Visible="False" VisibleIndex="5">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataComboBoxColumn Caption="Наименование" FieldName="AccessoriesProductId" ShowInCustomizationForm="True" VisibleIndex="2" Width="800px">
                                    <PropertiesComboBox DataSourceID="SqlDataSourceAccessoriesProduct" TextField="Name" ValueField="Id">
                                    </PropertiesComboBox>
                                </dx:GridViewDataComboBoxColumn>
                                <dx:GridViewDataComboBoxColumn Caption="Ед.изм." FieldName="AccessoriesProductId" ShowInCustomizationForm="True" VisibleIndex="3" Width="100px">
                                    <PropertiesComboBox DataSourceID="SqlDataSourceAccessoriesProduct" TextField="Unit" ValueField="Id">
                                    </PropertiesComboBox>
                                </dx:GridViewDataComboBoxColumn>
                            </Columns>
                        </dx:ASPxGridView>
                        <asp:SqlDataSource ID="SqlDataSourceAccessoriesTable" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" DeleteCommand="DELETE FROM [AccessoriesTable] WHERE [Id] = @Id" InsertCommand="INSERT INTO [AccessoriesTable] ([AccessoriesId], [AccessoriesProductId], [Quantity], [QuantityAgreed]) VALUES (@AccessoriesId, @AccessoriesProductId, @Quantity, @QuantityAgreed)" SelectCommand="SELECT * FROM [AccessoriesTable] WHERE ([AccessoriesId] = @AccessoriesId)" UpdateCommand="UPDATE [AccessoriesTable] SET [AccessoriesId] = @AccessoriesId, [AccessoriesProductId] = @AccessoriesProductId, [Quantity] = @Quantity, [QuantityAgreed] = @QuantityAgreed WHERE [Id] = @Id">
                            <DeleteParameters>
                        ...
                        <dx:ASPxPanel ID="ASPxPanel2" runat="server" RightToLeft="True" Width="100%">
                            ...
                            <PanelCollection>
                                <dx:PanelContent runat="server">
                                    <dx:ASPxButton ID="ASPxButton1" runat="server" AutoPostBack="False" Text="Закрыть">
