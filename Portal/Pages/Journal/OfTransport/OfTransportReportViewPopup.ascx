<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OfTransportReportViewPopup.ascx.cs" Inherits="Portal.Pages.Journal.OfTransport.OfTransportReportViewPopup" %>
