namespace Portal.Migrations
{
    ...
    public partial class Position : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Stationery", "IsActive", c => c.Boolean(nullable: false, defaultValue: true));
            CreateIndex("dbo.Employee", "PositionId");
            AddForeignKey("dbo.Employee", "PositionId", "dbo.Position", "Id");
            DropColumn("dbo.Employee", "Prof");
            DropColumn("dbo.Stationery", "GroupId");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Stationery", "GroupId", c => c.Int(nullable: false));
            ...
            DropColumn("dbo.Stationery", "IsActive");
